...
export default function DeleteClassDrawer({
    isOpen,
    className,
    onClose,
    onConfirm,
    isPending
}: DeleteClassDrawerProps) {
    ...
    const isMatch = confirmName.trim().toUpperCase() === className.trim().toUpperCase();
                ...
                >
                    ...
                    <div className="p-6 border-b border-light-border flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-sm font-semibold text-black tracking-tight">Delete Academic Class</h2>
                                <p className="text-xs text-black/40 font-normal">Permanently remove classroom level registration.</p>
                            </div>
                        </div>
                        <button
                            type="button"
                    ...
                    <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6 slim-scrollbar text-xs">
                            ...
                            <div className="flex items-start gap-2.5">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs mt-1.5 leading-relaxed text-black/70 font-medium">
                                        You are about to permanently delete the academic class <strong className="font-mono bg-red-100 px-1 py-0.5 rounded text-red-700 text-xs font-bold">Class {className}</strong>.
                                    </p>
                                </div>
                            </div>

                            <ul className="text-xs text-black/70 font-medium space-y-2 list-disc pl-4 pt-1">
                                <li>All linked sections, partitions, and allocations will be destroyed.</li>
                                <li>Linked fee structure configurations for this class will be deleted.</li>
                                <li>Student directories will lose class-level mappings.</li>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-black/45 leading-normal">
                                To proceed with the deletion, please type the class name <strong className="font-semibold text-black">{className}</strong> below:
                            </p>
                            <input
                                type="text"
                                required
