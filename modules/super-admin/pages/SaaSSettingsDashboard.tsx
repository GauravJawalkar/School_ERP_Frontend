...
export function SaaSSettingsDashboard() {
          ...
          <form onSubmit={handleSave} className="w-full md:w-3/4 bg-white border border-light-border rounded-xl p-6 shadow-xs space-y-6">
            ...
            {activeTab === "limits" && (
              <div className="space-y-4 animate-in fade-in duration-150">
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-black/70 block uppercase tracking-wider">Default Allowed Students Limit</label>
                  <input
                    type="number"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-black/70 block uppercase tracking-wider">Default Allowed Staff Limit</label>
                  <input
                    type="number"
                    required
