        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            <div className="p-3 bg-gray-50 border border-light-border rounded-lg flex gap-2.5 text-xs text-black/60 leading-relaxed">
              ...
              <span>
                This overrides the automated plan quota calculations, applying custom scaling configurations directly to <strong className="text-black">{school.schoolName}</strong>.
              </span>
            </div>
