        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            <div className="p-3 bg-gray-50 border border-light-border rounded-lg flex gap-2.5 text-xs text-black/60 leading-relaxed">
              ...
              <span>
                Updating the billing tier for <strong className="text-black">{school.schoolName}</strong> adjusts their resource limits and core LMS capabilities immediately.
              </span>
            </div>
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`w-full p-4 rounded-xl border text-left transition select-none cursor-pointer flex justify-between items-center ${
                        isSelected
                    ...
                    >
                      ...
                      <div className={`w-4 h-4 rounded-full flex items-center justify-center border ${
                        isSelected ? "bg-white text-black border-white" : "border-gray-300"
                      }`}>
