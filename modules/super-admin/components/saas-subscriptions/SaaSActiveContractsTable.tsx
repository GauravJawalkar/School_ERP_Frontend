                    ...
                    <tbody className="divide-y divide-light-border bg-white text-black/70">
                        {filtered.length === 0 ? (
                            ...
                            filtered.map((contract) => {
                                const formattedStartDate = contract.startDate ? new Date(contract.startDate).toLocaleDateString("en-IN", {
                                    day: "2-digit",
                                    month: "short",
                                    year: "numeric"
                                }) : "N/A";
                                const formattedRenewalDate = contract.renewalDate ? new Date(contract.renewalDate).toLocaleDateString("en-IN", {
                                    day: "2-digit",
                                    month: "short",
                                    year: "numeric"
                                }) : "N/A";
                                ...
                                return (
                                    <tr key={contract.contractId} className="hover:bg-gray-50/40 transition">
                                        ...
                                        <td className="px-4 py-3.5">
                                            <div>
                                                ...
                                                <span className="text-xs text-black/40 font-medium flex items-center gap-1 mt-0.5 lowercase font-mono">
                                                    ...
                                                    {contract.schoolSlug || "school"}.layernlooms.com
                                                </span>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-4 py-3.5">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-[10px] text-black/40 font-medium capitalize">
                                                    Billing cycle: {(contract.billingCycle || "MONTHLY").toLowerCase()}
                                                </span>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-4 py-3.5">
                                            ...
                                            {contract.billingStatus !== "ACTIVE" && contract.billingStatus !== "OVERDUE" && contract.billingStatus !== "SUSPENDED" && (
                                                <span className="inline-flex items-center gap-1 bg-gray-50 text-gray-700 px-2 py-0.5 rounded-full text-[10px] font-semibold border border-gray-200 uppercase">
                                                    {contract.billingStatus || "ACTIVE"}
                                                </span>
                                            )}
                                        </td>
