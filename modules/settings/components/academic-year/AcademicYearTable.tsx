...
import { AcademicYear } from "../../types/settings.types";
...
interface SettingsAcademicYearTableProps {
    years: AcademicYear[];
...
export default function AcademicYearTable({
    ...
    onToggleActive,
    updatingId
}: SettingsAcademicYearTableProps) {
    ...
    return (
        <DataTable<any>
            data={years}
            columns={columns}
            tableId="settings-academic-year-table"
