...
import { SchoolDetails } from "../../types/settings.types";

interface SchoolProfileOverviewProps {
    details?: SchoolDetails | any;
    schoolDetails?: SchoolDetails | any;
}

export default function SchoolProfileOverview({ details, schoolDetails: schoolDetailsProp }: SchoolProfileOverviewProps) {
    const schoolDetails = details || schoolDetailsProp;
