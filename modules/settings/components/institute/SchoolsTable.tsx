...
import { SchoolSummary } from "../../types/settings.types";
                                ...
                                filteredSchools.map((school, index) => (
                                    <tr key={school.id ? `school-${school.id}` : (school.slug ? `school-${school.slug}` : `school-idx-${index}`)} className="hover:bg-neutral-50/50 transition">
                                            ...
                                            <div className="flex items-center gap-3">
                                                {school.logoUrl ? (
                                                    <img
                                                        ...
                                                        className="w-9 h-9 rounded-lg object-contain border border-light-border p-0.5 bg-white select-none"
                                                    />
                                                ) : (
                                        ...
                                        <td className="p-4 font-medium text-black/75">
                                            {school.address || (school.city ? `${school.city}, ${school.state || ""}` : "N/A")}
                                        </td>
